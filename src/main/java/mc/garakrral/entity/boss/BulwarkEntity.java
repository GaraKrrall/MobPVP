package mc.garakrral.entity.boss;

import mc.garakrral.entity.goal.boss.BreakBlockGoal;
...
public class BulwarkEntity extends PathAwareEntity {
    ...
    protected void dropLoot(DamageSource source, boolean causedByPlayer) {
        ...
        if (!this.getWorld().isClient()) {
            ...
            this.dropStack(new ItemStack(ItemType.COPPER_STICK, 2));
            this.dropStack(new ItemStack(ItemType.KALP_ITEM, 2));
        }
