...
public class TallPvETowerPiece extends StructurePiece {
    private final BlockPos origin;

    public TallPvETowerPiece(BlockPos pos) {
        super(WorldGen.TALL_PVE_TOWER_PIECE, 0, BlockBox.create(
    ...
    public TallPvETowerPiece(StructureContext context, NbtCompound nbt) {
        super(WorldGen.TALL_PVE_TOWER_PIECE, nbt);
