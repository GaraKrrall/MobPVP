...
public class ReinforcedCopperMaceItem extends Item {
    private final float attackDamage;
    private final float attackSpeed;
    private final float knockbackRange;
    private final float knockbackPower;

    public ReinforcedCopperMaceItem(Settings settings, float attackDamage, float attackSpeed, float knockbackRange, float knockbackPower) {
        super(settings);
    ...
    public boolean canRepair(ItemStack stack, ItemStack ingredient) {
        return ingredient.isOf(Items.REINFORCED_COPPER_INGOT); // özelleştirilebilir
    }
