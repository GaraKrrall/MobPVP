...
import static com.kaplandev.strings.path.Paths.MOB_TABLE_ITEM_KEY;
...
public class Items {
    ...
    public static final Item MOB_TABLE = register(MOB_TABLE_ITEM_KEY, new BlockItem(Blocks.MOB_TABLE, new Item.Settings()));
    ...
    public static void init() {
        ...
        registerToTab(MOB_TABLE, Tabs.MOBPVP_GROUP_KEY);
