...
public class TallPvETower extends Structure {
    public static final MapCodec<TallPvETower> CODEC = (MapCodec<TallPvETower>) createCodec(TallPvETower::new);

    public TallPvETower(Config config) {
        super(config);
    }
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        return Structure.getStructurePosition(context, Heightmap.Type.WORLD_SURFACE_WG, collector -> {
            ...
            BlockPos pos = new BlockPos(cp.getCenterX(),
                    ...
                    cp.getCenterZ());
            collector.addPiece(new TallPvETowerPiece(pos));
        });
    }
    ...
    public StructureType<?> getType() {
        return WorldGen.TALL_PVE_TOWER_POND;
    }
}
