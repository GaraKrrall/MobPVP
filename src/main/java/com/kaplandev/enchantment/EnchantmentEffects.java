...
public class EnchantmentEffects {
    ...
    public static MapCodec<LightningStrikeEffect> LIGHTNING_EFFECT =
            register("lightning_effect", LightningStrikeEffect.CODEC);
    public static final RegistryKey<Enchantment> CERTAINTYSTRIKE = of("certainty_strike");
    public static MapCodec<CertaintyEffect> CERTAINTY_EFFECT =
            register("certainty_effect", CertaintyEffect.CODEC);
